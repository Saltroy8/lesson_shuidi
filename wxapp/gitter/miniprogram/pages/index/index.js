...
Page({
  data: {
    ...
    lang: languages[wx.getStorageSync(sinceCacheKey)] || languages[0],
    selectedIndices: [timeRange[wx.getStorageSync(sinceCacheKey) ]|| 0, languages[wx.getStorageSync(sinceCacheKey)] || 0], //picker valuer
  ...
  reloadData () {
    ...
    github.trendings(since.value, lang.value).then(
      data => {
        console.log(data,'++++++++');
      }
    ).catch( () => {
