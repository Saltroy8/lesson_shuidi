...
var _ = require('lodash'); // jquery  dom $('#app').html('dfdfdfdf')
...
var MyComponent = function MyComponent(props) {
  var compiler = MyComponent.cache || (MyComponent.cache = template('<h1><%= title %></h1>')); //模板可以复用
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5655" + '/');
